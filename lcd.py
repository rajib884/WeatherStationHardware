...
def add_lcd_chars():
    ...
    lcd_chars = [
        ...
        [0x08, 0x04, 0x02, 0x01, 0x02, 0x04, 0x08, 0x00],  # right array
    ]
    ...
    while 1:
        ...
        lcd.custom_char(5, [0x08, 0x04, 0x02, 0x01, 0x02, 0x04, 0x08, 0x00])
        time.sleep_ms(200)
        lcd.custom_char(5, [0x04, 0x02, 0x01, 0x10, 0x01, 0x02, 0x04, 0x00])
        time.sleep_ms(200)
        lcd.custom_char(5, [0x02, 0x01, 0x10, 0x08, 0x10, 0x01, 0x02, 0x00])
        time.sleep_ms(200)
        lcd.custom_char(5, [0x01, 0x10, 0x08, 0x04, 0x08, 0x10, 0x01, 0x00])
        time.sleep_ms(200)
        ...
        lcd.custom_char(5, [0x10, 0x08, 0x04, 0x02, 0x04, 0x08, 0x10, 0x00])
        time.sleep_ms(200)
